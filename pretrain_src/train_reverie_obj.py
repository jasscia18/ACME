...
def main(opts):
    ...
    #print('this is cc:', checkpoint)
    model = model_class.from_pretrained(
        pretrained_model_name_or_path="../bert-base-uncased", config=model_config, state_dict=checkpoint
    )
    model.train()
    ...
    #print('this si ddd:', opts.train_datasets['REVERIE'])
    # print('this is ida:', data_cfg)
