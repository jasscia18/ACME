...
from agent_obj import GMapObjectNavAgent
from data_utils import ObjectFeatureDB, construct_instrs, load_obj2vps
from env import ReverieObjectNavBatch
...
def valid(args, train_env, val_envs, rank=-1):
    ...
    for env_name, env in val_envs.items():
        ...
        print('this si oo:', output_file)
        print('this si env:', env)
...
def main():
    ...
    _, n_gpu, device = set_cuda(args)

    print('this si nn:', n_gpu, device)
