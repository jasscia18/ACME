...
class EnvBatch(object):
    ...
    def getStates(self):
        ...
        for i, sim in enumerate(self.sims):
            ...
            #print('th is is feateu:', feature.shape)  #(36, 768)
...
class R2RNavBatch(object):
    ...
    def __init__(
        ...
        #print('th is is view_db:', view_db)
    ...
    def make_candidate(self, feature, scanId, viewpointId, viewId):
        ...
        if long_id not in self.buffered_state_dict:
            for ix in range(36):
                ...
                #print('this is vv11111111111:', visual_feat.shape)  #(768,)
                ...
                for j, loc in enumerate(state.navigableLocations[1:]):
                    ...
                    #print('this is angle_feat2322222:', angle_feat.shape)  #(4,)
    ...
    def _get_obs(self):
        ...
        for i, (feature, state) in enumerate(self.env.getStates()):
            item = self.batch[i]
            #print('th is is item:', item)
            base_view_id = state.viewIndex
            #print('th is is ff:', feature.shape)  # (36, 768)
           
            # Full features
            candidate = self.make_candidate(feature, state.scanId, state.location.viewpointId, state.viewIndex)
            # [visual_feature, angle_feature] for views
            #print('th is is ff111111:', feature.shape)  #(36, 768)
            feature = np.concatenate((feature, self.angle_feature[base_view_id]), -1)
            #print('th is is feature22222:', feature.shape)  #(36, 772)
